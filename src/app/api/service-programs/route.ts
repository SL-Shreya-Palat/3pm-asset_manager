...
import { getAllServicePrograms, createServiceProgram } from '@/controller/service-programs';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await createServiceProgram(user.currentTenantId, user.id, body);
