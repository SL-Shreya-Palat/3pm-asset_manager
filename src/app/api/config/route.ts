...
const ENDPOINTS = [
  ...
  },
  {
    ...
    listArrayPath: 'data.items',
    fieldSchema: [
      { name: 'id', path: 'id', type: 'objectId', description: 'Unique part identifier', isIdentifier: true },
      { name: 'name', path: 'name', type: 'string', description: 'Part name', isIdentifier: true },
      { name: 'partNumber', path: 'partNumber', type: 'string', description: 'Part number', isIdentifier: true },
      { name: 'categoryId', path: 'categoryId', type: 'objectId', description: 'Part category' },
      ...
      { name: 'isActive', path: 'isActive', type: 'boolean', description: 'Whether the part is active', groupable: true },
      { name: 'createdAt', path: 'createdAt', type: 'date', description: 'Record creation date', dateLike: true },
    ],
  },
  {
