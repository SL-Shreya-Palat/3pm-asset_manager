...
const FORM_ID = 'settings.measurementUnits.measurementUnit';
...
export async function GET(request: NextRequest) {
  ...
  const items = await getAllMeasurementUnits(user.currentTenantId, search, { showArchived, createdBy, userId: user.id });
