...
import { getAllAssetTypes, createAssetType, updateAssetType, deleteAssetType, archiveAssetType } from '@/controller/assetTypes';
...
export async function GET(request: NextRequest) {
  ...
  const items = await getAllAssetTypes(user.currentTenantId, search, { showArchived });
