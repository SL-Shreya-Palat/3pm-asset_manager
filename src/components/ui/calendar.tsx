  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          'relative has-focus:border-primary-500 border border-input shadow-xs has-focus:ring-primary-500/20 has-focus:ring-[1px] rounded',
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        'data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground group-data-[focused=true]/day:border-primary-500 group-data-[focused=true]/day:ring-primary-500/20 dark:hover:text-accent-foreground flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-1 data-[range-end=true]:rounded data-[range-end=true]:rounded-r data-[range-middle=true]:rounded-none data-[range-start=true]:rounded data-[range-start=true]:rounded-l [&>span]:text-xs [&>span]:opacity-70',
        defaultClassNames.day,
        className,
      )}
      {...props}
