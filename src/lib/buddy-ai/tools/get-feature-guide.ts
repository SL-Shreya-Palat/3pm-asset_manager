...
const ROUTE_DESCRIPTIONS: Record<string, string> = {
  ...
  "/inspections/exception-report":
    "Compliance calendar (asset × form × day) showing inspected days, exceptions, and gaps.",
  ...
  "/maintenance/service-plans": "Service plans — recurring schedules (e.g. A/B/C/D services) assigned to assets.",
  ...
  "/maintenance/faults": "Faults reported directly by drivers or staff (outside inspections).",
